...
const VFM_KAPPA: float = -1.0  # SCVC sign convention: CCW ring self-induces UP
...
func compute_all(seg_pos: PackedFloat32Array, seg_map: PackedInt32Array, ring_off: PackedInt32Array, ring_rad: PackedFloat32Array, vor_pos: PackedFloat32Array, n_seg: int, n_ring: int, n_vor: int) -> PackedFloat32Array:
	...
	var push: PackedFloat32Array = PackedFloat32Array([float(n_seg),float(n_ring),float(n_vor),VFM_KAPPA, VFM_CORE_A, VFM_SELF_CORE_F, 0.0, 0.0])  # padded to 32 bytes
